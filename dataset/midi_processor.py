...
if __name__ == '__main__':
    encoded = encode_midi('MusicTransformer-Pytorch/jasmine.mid')
    print(encoded)
    decided = decode_midi(encoded,file_path='/root/wyl/MusicTransformer-Pytorch/decided.midi')

    ins = pretty_midi.PrettyMIDI('MusicTransformer-Pytorch/jasmine.mid')
    print(ins)
    print(ins.instruments)
    print(len(ins.instruments))
